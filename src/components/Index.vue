            ...
            <div class="sc">
                <div class="ct">
                    ...
                    <div class="pp">
                        ...
                        soy estudiante activo de <strong class="subRayado"><a href="https://www.usbbog.edu.co/" class="txtColor" target="_blank">
                        Ingeniería Mecatrónica</a></strong> en la Universidad de<strong> San Buenaventura - Sede Bogota</strong> y de la plataforma de aprendizaje virtual 
...
.bn>div>span:nth-child(1) {
    ...
    transition: transform .3s, top .8s .8s;
    animation: clickTop .5s ease-in-out forwards reverse;
    transform: rotate(0);
}
...
.bn>div>span:nth-child(2) {
    ...
    transition: transform .3s, bottom .8s .8s;
    animation: clickBottom .5s ease-in-out forwards reverse;
    transform: rotate(0);
}

.bn:active span:nth-child(1) {
    animation: clickTop .5s ease-in-out forwards;
    transform: rotate(45deg);
}

.bn:active span:nth-child(2) {
    animation: clickBottom .5s ease-in-out forwards;
    transform: rotate(-45deg);
}
...
.txtColor2 {
    background-image: linear-gradient(320deg, #2193b0, #6dd5ed);
}
...
.subRayado2,
.sc {
    background-image: linear-gradient(to left, #16141c, #09080b);
}
...
.sc {
    padding: calc(100px + 80 * (100vw - 320px) / 1080) 0;
    font-weight: 200;
    color: #edf1f3;
...
.com .ct h2 {
    line-height: calc(45px + 7 * (100vw - 320px) / 1080);
}

.com .ct strong {
    font-weight: 200;
    font-size: calc(41px + 7 * (100vw - 320px) / 1080);
}
...
.com .bt {
    height: 100%;
    margin-top: calc(50px + 7 * (100vw - 320px) / 1080);
    text-align: center;
}
...
.com .iconList {
    ...
    /* margin-top: calc(20px + 7 * (100vw - 320px) / 1080); */
}
...
@media only screen and (max-width: 720px) {
    ...
    .com .ct strong {
        font-size: calc(28px + 7 * (100vw - 320px) / 1080);
    }
    .com .ct small {
    ...
    .cn>img {
        width: calc(22px + 20 * (100vw - 320px) / 1080);
    }
}
</style>